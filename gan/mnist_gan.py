...
H = Conv2D(256, (5, 5), subsample=(2, 2), padding = 'same', activation='relu', data_format="channels_first")(d_input)
H = LeakyReLU(0.2)(H)
H = Dropout(dropout_rate)(H)
H = Conv2D(512, (5, 5), subsample=(2, 2), padding = 'same', activation='relu', data_format="channels_first")(H)
H = LeakyReLU(0.2)(H)
H = Dropout(dropout_rate)(H)
H = Flatten()(H)
H = Dense(256)(H)
...
print "measuring accuracy of pre-trained discriminator network"
...
print "training for 6000 epochs"
